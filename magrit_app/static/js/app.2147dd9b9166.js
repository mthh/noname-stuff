...
(function () {
  ...
  i18next.use(i18nextXHRBackend).init({
    ...
    backend: {
      loadPath: 'static/locales/{{lng}}/translation.2147dd9b9166.json'
    }
  }, function (err, tr) {
    if (err) {
      throw err;
...
function add_sample_layer() {
  ...
  var suggested_projection = new Map([['GrandParisMunicipalities', ['d3', 'ConicConformalFrance']], ['martinique', ['proj4', '+proj=utm +zone=20 +ellps=intl +towgs84=186,482,151,0,0,0,0 +units=m +no_defs']], ['nuts2-2013-data', ['proj4', '+proj=laea +lat_0=52 +lon_0=10 +x_0=4321000 +y_0=3210000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs']], ['brazil', ['proj4', '+proj=longlat +ellps=aust_SA +towgs84=-67.35,3.88,-38.22,0,0,0,0 +no_defs']], ['world_countries_data', ['d3', 'NaturalEarth2']]]);
